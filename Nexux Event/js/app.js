  ...
  if (payBtn) {
    payBtn.addEventListener('click', () => {
      ...
      modalSummary.innerHTML = `
        ...
        <div style="font-size:0.8rem;color:#666;margin-bottom:0.4rem;">📅 ${eventSelect.value}</div>
        ${lineHTML}
        ...
        <div style="margin-top:0.6rem;font-size:0.8rem;color:#555;">Payment via ${payMethod} · Ref: NX-${Math.random().toString(36).slice(2,9).toUpperCase()}</div>
      `;
